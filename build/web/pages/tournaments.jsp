                        ...
                        <main id="tournament">
                                ...
                                <ul class="round round-2">
                                        ...
                                        <li class="game game-top">
                                            ...
                                            <% if (
                                                ...
                                                { %>
                                                <a class="bold" href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(0).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(0).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(1).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        <li class="game game-spacer">&nbsp;</li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(1).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(2).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        <li class="game game-spacer">&nbsp;</li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(2).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(3).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        <li class="game game-spacer">&nbsp;</li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(3).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                ...
                                <ul class="round round-3">
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(4).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        <li class="game game-spacer">&nbsp;</li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(4).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(5).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        <li class="game game-spacer">&nbsp;</li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(5).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                ...
                                <ul class="round round-4">
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(6).getwToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
                                        <li class="game game-spacer">&nbsp;</li>
                                        ...
                                        <% if (
                                                ...
                                                { %>
                                                <a class="bold"  href="http://51.15.98.160/play#/<%= tournaments.get(i).getGames().get(6).getbToken() %>">Enter Game</a>
                                            <% } %>
                                        </li>
